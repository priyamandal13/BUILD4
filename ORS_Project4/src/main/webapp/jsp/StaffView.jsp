        ...
        <form action="<%=ORSView.STAFF_CTL%>" method="post">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><font color="red" id="fullNameError"><%=ServletUtility.getErrorMessage("fullName", request)%></font></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><font color="red"><%=ServletUtility.getErrorMessage("joiningDate", request)%></font></td>
                </tr>
