		...
		<tr>
			...
			<td colspan="2"><font style="font-size: 18px"> <a
				...
				%> <a href="<%=ORSView.MARKSHEET_CTL%>">Add Marksheet</b></a> | <a
					...
					href="<%=ORSView.TIMETABLE_CTL%>">Add TimeTable</b></a> | 
					<a
					href="<%=ORSView.TIMETABLE_LIST_CTL%>">TimeTable List</b></a> | 
					
				<%-- 
				<a href="<%=ORSView.INVENTORY_CTL%>">Add Inventory</b></a> | <a
					href="<%=ORSView.INVENTORY_LIST_CTL%>">InventoryList</b></a> | --%>
					
					<%-- <a href="<%=ORSView.ORDER_CTL%>">Add Order</b></a> | <a
					href="<%=ORSView.ORDER_LIST_CTL%>">OrderList</b></a> | --%>
					<a
					...
					href="<%=ORSView.STAFF_CTL%>">Add Staff</b></a> | <a
					href="<%=ORSView.STAFF_LIST_CTL%>">Staff List</b></a>|
